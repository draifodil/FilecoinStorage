...
const contractABI = require("../artifacts/contracts/Filecoinstorage.sol/Filecoinstorage.json").abi;

program
    .name("filecoinstorage-cli")
    .description("CLI tool for Filecoinstorage smart contract")
    .version("1.0.0");
